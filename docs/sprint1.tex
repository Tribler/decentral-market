...
Anyone can declare that his username is Alice and can then validate transactions in the name of Alice, without the consent of the real Alice.
...
Lastly, once an offer is expired, Bob can no longer request a trade on it.